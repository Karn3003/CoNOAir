...
for ep in range(epochs):
    ...
    wandb.log({"epoch": ep, "train_l2_full": train_l2_full / ntrain, "train_l2_step": train_l2_step / ntrain / (T_out / step), "test_l2_full": test_l2_full / ntest, 
               "test_l2_step": test_l2_step / ntest / (T_out / step),"time": t2-t1})

...
class Model(nn.Module):
    def __init__(self, args):
        ...
        # self.conv0 = SpectralFractionalConv2d(self.width, self.width, self.modes1, self.modes2, alpha=1)
        # self.conv1 = SpectralFractionalConv2d(self.width, self.width, self.modes1, self.modes2, alpha=1)
        # self.conv2 = SpectralFractionalConv2d(self.width, self.width, self.modes1, self.modes2, alpha=1)
        # self.conv3 = SpectralFractionalConv2d(self.width, self.width, self.modes1, self.modes2, alpha=1)
